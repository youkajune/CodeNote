...
|ios_base::out|"w"|打开文件以写入。等价于 ios_base::out\|ios_base::trunc。<br>1.打开文件，只写；<br>2.若文件不存在，则新建文件；<br>3.若成功打开文件，从文件开头写入；<br>3.会清空文件原有内容。
|ios_base::out\|ios_base::trunc|"w"|打开文件以写入。等价于 ios_base::out\|ios_base::trunc。<br>1.打开文件，只写；<br>2.若文件不存在，则新建文件；<br>3.若成功打开文件，从文件开头写入；<br>3.会清空文件原有内容。
